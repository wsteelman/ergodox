...
static void on_adv_evt(ble_adv_evt_t ble_adv_evt)
{
    ...
    switch (ble_adv_evt)
    {
        case BLE_ADV_EVT_DIRECTED:
            ...
            led_indication(BSP_INDICATE_ADVERTISING_DIRECTED);
            break; //BLE_ADV_EVT_DIRECTED

        case BLE_ADV_EVT_FAST:
            //NRF_LOG_INFO("BLE_ADV_EVT_FAST\r\n");
            led_indication(BSP_INDICATE_ADVERTISING);
            break; //BLE_ADV_EVT_FAST

        case BLE_ADV_EVT_SLOW:
            //NRF_LOG_INFO("BLE_ADV_EVT_SLOW\r\n");
            led_indication(BSP_INDICATE_ADVERTISING_SLOW);
            APP_ERROR_CHECK(err_code);
            break; //BLE_ADV_EVT_SLOW

        case BLE_ADV_EVT_FAST_WHITELIST:
            //NRF_LOG_INFO("BLE_ADV_EVT_FAST_WHITELIST\r\n");
            led_indication(BSP_INDICATE_ADVERTISING_WHITELIST);
    ...
    if (p_evt->params.char_write.char_id.rep_type == BLE_HIDS_REP_TYPE_OUTPUT)
    {
        ...
        if (report_index == OUTPUT_REPORT_INDEX)
        {
            ...
            if (!m_caps_on && ((report_val & OUTPUT_REPORT_BIT_MASK_CAPS_LOCK) != 0))
            {
                ...
                led_indication(BSP_INDICATE_ALERT_3);
            ...
            else if (m_caps_on && ((report_val & OUTPUT_REPORT_BIT_MASK_CAPS_LOCK) == 0))
            {
                ...
                led_indication(BSP_INDICATE_ALERT_OFF);
...
static void on_ble_evt(ble_evt_t * p_ble_evt)
{
    ...
    switch (p_ble_evt->header.evt_id)
    {
        case BLE_GAP_EVT_CONNECTED:
            ...
            led_indication(BSP_INDICATE_CONNECTED);
